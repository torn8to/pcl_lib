...
#
get_filename_component(filename "/home/nathan/pcl_lib/build/_deps/rapids-cmake-tmp/branch-25.10.zip" ABSOLUTE)
get_filename_component(directory "/home/nathan/pcl_lib/build/_deps/rapids-cmake-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-rapids-cmake${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-rapids-cmake${i}")
